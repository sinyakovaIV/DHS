...
//    [Item.Index].ValueByName('ID_OUT');
  ...
  fJournalPedagogueByIndividualGroupChild.StrEducationProgram := ValueByName('STR_PROGRAM');
  fJournalPedagogueByIndividualGroupChild.StrLearningLevel := ValueByName('STR_LEVEL');
