...
type
  ...
  private
    ...
    FIDStatus: integer; // а где тут он исп-ся??? уточнить!!!
...
var
  i: integer;
begin
  rgChooseMode.ItemIndex := 0;  // если форма уже была открыта, то rgChooseMode.ItemIndex запоминается оттудова,
  // даже если форм закрывалась, так что это дело не работает, надо подумать!!!!!!!!!
